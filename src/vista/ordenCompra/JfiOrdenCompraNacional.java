...
public class JfiOrdenCompraNacional extends javax.swing.JInternalFrame {

    public JfiOrdenCompraNacional(String IGV) {
        this.jfiAddProducto = new JfiAddProducto(ListArticulo, null, IGV, "n");
        initComponents();
        this.setSize(new Dimension(950, 520));
        this.setTitle("Orden de Commpra Nacional");
        ...
        this.valIGV = Double.parseDouble("1." + IGV);
        //CentroCosto
        ...
        InputNro2.setText(String.valueOf(ano));
        InputNro2.setEditable(false);
        InputNro2.setEnabled(false);
        //nr1 title 4 digitos
        getNumCorrel();
    }
    ...
    //var tabla
    public static ArrayList<ItemOrdenCompraNacional> ListArticulo = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        InputNro1 = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        InputNro2 = new javax.swing.JTextField();
        ...
        InputNro1.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        InputNro1.setToolTipText("");
        InputNro1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                InputNro1ActionPerformed(evt);
            }
        });
        getContentPane().add(InputNro1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 60, 40));

        jLabel2.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        jLabel2.setText("-");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 30, 10, -1));

        InputNro2.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        getContentPane().add(InputNro2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, 40, 40));
        ...
        getContentPane().add(InputFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 90, 190, -1));

        InputContacto.setToolTipText("");
        getContentPane().add(InputContacto, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 190, -1));
        getContentPane().add(InputTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 150, 190, -1));
        getContentPane().add(InputEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 180, 190, -1));

        InputCtaCteBanco.setToolTipText("");
        getContentPane().add(InputCtaCteBanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 210, 190, -1));
    ...
    private void InputNro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InputNro1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_InputNro1ActionPerformed
    ...
    private void BtnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRegistrarActionPerformed
        ...
        if (!error) {
            OrdenCompraNacional compraNacional = new OrdenCompraNacional();
            ConOrdenCompra metCompraNacional = new ConOrdenCompra();
            ItemOrdenCompraNacional itemCompraNacional = new ItemOrdenCompraNacional();
            ConProveedor metodProv = new ConProveedor();
            ...
            compraNacional.setAno_ord_com_nac(metCompraNacional.getAnoActual("c"));
            compraNacional.setNum_ord_com_nac(metCompraNacional.getUltOrdenCompraNacional() + 1);

            String fec = String.valueOf(fecha);
            String[] split1 = fec.split("-");
            int periodo = Integer.parseInt(split1[1]);

            compraNacional.setPeriodo_est_com_nac(periodo);
            compraNacional.setId_proveedor(idProveedor);
            compraNacional.setCotizacion(InputCotizacion.getText());
            compraNacional.setFec_ord_com(fecha);
            compraNacional.setCon_ord_com(InputContacto.getText());
            compraNacional.setTel_ord_com(InputTelefono.getText());
            compraNacional.setEmail(InputEmail.getText());
            compraNacional.setCta_cte_ban_ord_com(InputCtaCteBanco.getText());
            compraNacional.setCen_cos_ord_com(IdCenCosto);
            compraNacional.setFec_ent_ord_com(fechaEntrega);
            compraNacional.setLug_ent_ord_com(InputLugEntrega.getText());
            if (ComboForPago.getSelectedItem().toString().equals("Crédito")) {
                compraNacional.setFor_pago_ord_com("C");
            } else if (ComboForPago.getSelectedItem().toString().equals("Contado")) {
                compraNacional.setFor_pago_ord_com("E");
            }

            if (compraNacional.getFor_pago_ord_com().equals("C")) {
                compraNacional.setPag_cre_dias(Integer.parseInt(SpinDias.getValue().toString()));
            } else {
                compraNacional.setPag_cre_dias(0);
            }

            compraNacional.setSol_ord_com(InputPerSolicitud.getText());

            if (ComboMoneda.getSelectedItem().toString().equals("Soles")) {
                compraNacional.setImp_bruto_sol(new BigDecimal(LabelImporteBruto.getText()));
                compraNacional.setDescuento_sol(new BigDecimal(LabelDescuento.getText()));
                compraNacional.setSub_total_sol(new BigDecimal(LabelSubTotal1.getText()));
                compraNacional.setTotal_sol(new BigDecimal(LabelTotal.getText()));
            }

            if (ComboMoneda.getSelectedItem().toString().equals("Dolares")) {
                compraNacional.setImp_bruto_dol(new BigDecimal(LabelImporteBruto.getText()));
                compraNacional.setDescuento_dol(new BigDecimal(LabelDescuento.getText()));
                compraNacional.setSub_total_dol(new BigDecimal(LabelSubTotal1.getText()));
                compraNacional.setTotal_dol(new BigDecimal(LabelTotal.getText()));
            }

            int vIGV = (int) ((valIGV * 100) - 100);
            compraNacional.setIgv(vIGV);
            compraNacional.setObservacion(InputObs.getText());

            int contador = 0;

            try {
                if (metCompraNacional.insOrdCompraNac(compraNacional, (ComboMoneda.getSelectedItem().toString()))) {

                    for (int i = 0; i < ListArticulo.size(); i++) {
                        ListArticulo.get(i).setRef_ano_ord_com(metCompraNacional.getAnoActual("c"));
                        ListArticulo.get(i).setRef_num_ord_com(compraNacional.getNum_ord_com_nac());
                        ListArticulo.get(i).setPeriodo_ord_com(periodo);
                        ListArticulo.get(i).setItem_ord_com(i + 1);
                        try {
                            metCompraNacional.itemOrdCompraNac(ListArticulo.get(i));
                        } catch (Exception e) {
                    ...
                    JOptionPane.showMessageDialog(null, "Error al momento de guardar la cabecera de compra. Revisar los datos ingresados");
                }
            } catch (Exception e) {
                JOptionPane.showConfirmDialog(null, e);
            }
            if ((contador) == ListArticulo.size()) {
                JOptionPane.showMessageDialog(null, "Se agrego la Orden de Compra Nacional " + compraNacional.getNum_ord_com_nac() + "-" + metCompraNacional.getAnoActual("d") + " satisfactoriamente.");
    ...
    private void RellTabla() {
        ...
        for (int i = 0; i < ListArticulo.size(); i++) {
            ...
            BigDecimal precioU = ListArticulo.get(i).getPrecioU().multiply(new BigDecimal(String.valueOf(ListArticulo.get(i).getCantidad())));
    ...
    private void getNumCorrel() {
        InputNro1.setEditable(false);
        InputNro1.setEnabled(false);
        ConOrdenCompra metodOCN = new ConOrdenCompra();
        int UltOCN = metodOCN.getUltOrdenCompraNacional() + 1;
        if (UltOCN < 10) {
    ...
    private javax.swing.JTextField InputNro1;
    private javax.swing.JTextField InputNro2;
