...
public class JfiNewSalidaMovAlmacen extends javax.swing.JInternalFrame {

    public JfiNewSalidaMovAlmacen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nueva Salida de Almacén");
        ...
        getContentPane().add(ComboItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 180, -1));

        jLabel3.setText("Almacén salida:");
        ...
        getContentPane().add(ComboAlm, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 180, -1));
        ...
        getContentPane().add(CalendarFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 180, -1));
        ...
        getContentPane().add(BtnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, -1, -1));
        ...
        getContentPane().add(SpinCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 80, -1));
        ...
        getContentPane().add(InputMotivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 180, -1));
    ...
    private void BtnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRegistrarActionPerformed
        ...
        if (ComboCategoria.getSelectedItem().toString().equalsIgnoreCase("Seleccione una categoria")) {
            ...
            stock = conInv.regItemInventario(inv, "S");
            
            if (stock >= 0 && metod.InsSalidaMovAlmacen(movAlm)) {
                JOptionPane.showMessageDialog(null, "Se inserto correctamente el movimiento, el stock acual es de: " + stock);
            }else{
                JOptionPane.showMessageDialog(null, "No se pudo completar el registro de salida, la cantidad supera el stock actual");
            }
        }
